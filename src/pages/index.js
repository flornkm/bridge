    ...
    return (
        <>
            ...
            <main className="max-md:w-[90%] w-full max-w-7xl pl-[5%] pr-[5%] m-auto bg-white min-h-[200vh]">
                <div className="min-h-64 pt-48 relative z-20">
                    <div className="max-w-2xl flex flex-col gap-6 mb-20">
                        ...
                        <p className="text-gray-500 font-medium text-3xl">Bridge connects interactive, prestyled and
                            modern popups to your application.</p>
                    </div>
                    <div className="flex justify-between absolute left-[50%] translate-x-[-50%] w-screen overflow-hidden py-10 pl-[5%] pr-[5%] items-center">
                        ...
                        <div className="py-4 px-8 bg-white z-20 shadow-2xl rounded-2xl ring-1 ring-neutral-200 absolute left-[50%] translate-x-[-50%] w-[90%] md:max-w-5xl flex justify-between">
                            <div className="flex flex-col gap-3">
                                    <h3 className="font-semibold text-3xl">We use cookies on our site</h3>
                                    <p className="text-xl text-gray-500">You can learn more about that on our privacy policy.</p>
                            </div>
                            <div className="flex gap-10">
                                <button className="bg-black text-white font-medium px-4 py-2 rounded-lg">Accept</button>
                            </div>
                        </div>
