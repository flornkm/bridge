...
const CommandMenu = (props) => {
  ...
  return (
    <Command.Dialog open={props.open} onOpenChange={props.setOpen} className="fixed min-w-[712px] pb-8 shadow-xl bg-opacity-50 backdrop-blur-lg z-50 left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%] bg-white rounded-lg ring-1 flex flex-col gap-8 ring-neutral-200">
